...
import numpy as np
# 类和索引
CLASSES = ["leftright", "person", "drowsy", "mobile", "R", "RG", "RR", "RY", "LR", "Pedestrain", "LY", "G", "B", "FR", "FG"]   # 改这
...
if __name__ == "__main__":
    ...
    dir_json = "/Users/jim/workspace/sleepy/rv1103/easyai/display/six/jsonlabs/"
    # txt文件夹 想让生成的txt文件放哪就改到哪个路径
    dir_txt = "/Users/jim/workspace/sleepy/rv1103/easyai/display/six/txtlabs/"
