...
path = "/Users/jim/workspace/sleepy/rv1103/easyai/display/seven/verity"         # jpg图片和对应的生成结果的txt标注文件，放在一起
    ...
    if img_ in txt_total:
        ...
        with open(os.path.join(path,filename_txt),"r+",encoding="utf-8",errors="ignore") as f:
            for line in f:
                ...
                cv2.putText(roi, aa[0], (100, 100), cv2.FONT_HERSHEY_COMPLEX, 2.0, (100, 200, 200), 5)
